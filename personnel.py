...
def Add():
    ...
    try:
       ...
       messagebox.showinfo("information", "Personnel inserted successfully...")
       e1.delete(0, END)
       e2.delete(0, END)
       e3.delete(0, END)
       e4.delete(0, END)
...
root.title("Personnel")
global e1
global e2
global e3
global e4

#tk.Label(root, text="Personnel Registation", fg="red", font=(None, 30)).place(x=300, y=5)

label = CTkLabel(root, text="Personnel ID").place(x=10, y=10)
label = CTkLabel(root, text="Personnel Name").place(x=10, y=40)
