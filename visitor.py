...
def Add():
    ...
    try:
       ...
       messagebox.showinfo("information", "Visitor inserted successfully...")
       e1.delete(0, END)
       e2.delete(0, END)
       e3.delete(0, END)
       e4.delete(0, END)
...
#tk.Label(root, text="Visitor Registation", fg="red", font=(None, 30)).place(x=300, y=5)

label = CTkLabel(root, text="Visitor ID").place(x=10, y=10)
label = CTkLabel(root, text="Visitor Name").place(x=10, y=40)
